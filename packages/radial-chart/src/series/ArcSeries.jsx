...
const propTypes = {
    ...
    centerValueLabel: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
...
export default class ArcSeries extends React.PureComponent {
    render() {
        const {
            data,
            radius,
            ...
            <g>
                <Arc
                    ...
                    onMouseMove={
                        ...
                        ((datum) => (event) => {
                            const fraction =
                                Math.abs(datum.startAngle - datum.endAngle) / (2 * Math.PI);
                            onMouseMove({
                                event,
                                data,
                                datum: datum.data,
                ...
                labelComponent && (
                    <Arc
                        ...
                        centroid={(centroid, arc) => {
                            ...
                            if (
                                arc.endAngle - arc.startAngle < MIN_ANGLE_FOR_LABEL ||
                                !labelElement
                            )
                                return null;
